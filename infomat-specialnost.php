...
.round {
	...
	background-image: url(img/Treatment-Plan.png);
...
<body>
	...
	<div class="row" style="margin-top: -5px">
		<h1 class="select_specialist" >Выберите специальность</h1>
	</div>
	<!-- ******************************************************** -->
	...
	<div class="row">
		...
		<div data-toggle="buttons" style="margin-top: 43pt; margin-left: 1525px">
  			...
  			<label class="btn select_page" style="margin: 12px">
    			<input type="radio" >2
  			</label>
  			<label class="btn select_page" style="margin: 12px">
    			<input type="radio" >3
